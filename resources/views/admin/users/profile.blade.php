...
<div class="card">
  <div class="card-header">
    ...
    <div class="card-body">
      <form class="form-group" action="{{Route('profile.index')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <input type="text" class="form-control" name="facebook" value="{{$user->facebook}}"><br>
        <label for="tag">Youtube</label>
        <input type="text" class="form-control" name="youtube" value="{{$user->youtube}}"><br>
        <label for="tag">About You</label>
        <textarea name="about" rows="6" cols="95">{{$user->about}}</textarea><br>
