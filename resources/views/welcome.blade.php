                          ...
                          @foreach($wordpress->post()->orderBy('created_at', 'desc')->take(3)->get() as $posts)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title text-center"><a href="#">{{$posts->title}}</a></h6>
                                </div>
                            </div>
                            @endforeach
                        </div>
                          ...
                          @foreach($android->post()->orderBy('created_at', 'desc')->take(3)->get() as $android)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title text-center"><a href="#">{{$android->title}}</a></h6>
                                </div>
                            </div>
                            @endforeach
                        </div>
